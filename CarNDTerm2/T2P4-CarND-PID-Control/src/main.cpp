...
{
    PID pid;
    std::vector<double> p = twiddle.GetParameters();
            ...
            if (s != "")
            {
                ...
                if (event == "telemetry")
                {
                    ...
                    */
                    ...
                    pid.UpdateErrors(cte, speed - target_speed);
                    double steer_value = pid.CalcualteSteeringAngle();

                    // DEBUG
                    // std::cout << "Steps: " << n_steps << " CTE: " << cte << " Steering Value: " << steer_value << std::endl;
                    // std::cout << "TotalError: " << pid.TotalError() << std::endl;

                    json msgJson;
                    msgJson["steering_angle"] = steer_value;
                    msgJson["throttle"] = pid.CalcualteThrottling();
